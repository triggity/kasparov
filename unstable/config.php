...
$database_name = "scu_tech_help_dev";
$database_uname = "stdsvc_dev";
$database_upass = "devdev";
...
$color_table_title = "006000"; //Title bar on tables
...
$color_page_lt_bg = "FFFFFF"; //background of main column / tables in left column
$color_page_dk_bg = "A0A0A0"; //background of left column
