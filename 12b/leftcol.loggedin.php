...
<TABLE width=100% cellspacing=0 cellpadding=3 border=0>
<TR><TD bgcolor=<?=$color_table_title?>><?=$ofont_title?>Lab 206 Count:<?=$cfont_title?></TD></TR>
<TR><TD bgcolor=<?=$color_page_lt_bg?>><B>
        <LI><A HREF="librarycount.php?SID=<?echo $SID;?>">Library Count</A>
	<? if($userdata["IsAdmin"]=="Y"){ ?>
	<LI><A HREF="viewlibrarycount.php?SID=<?echo $SID;?>">View Library Count</A>
	<? } ?>
</B></TD></TR>
</TABLE>
<BR>
