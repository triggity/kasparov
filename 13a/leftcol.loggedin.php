...
<!--Head Count implemented 2/8/2010-->
<TABLE width=100% cellspacing=0 cellpadding=3 border=0>
<TR><TD bgcolor=<?=$color_table_title?>><?=$ofont_title?>Library Computer Usage:<?=$cfont_title?></TD></TR>
<TR><TD bgcolor=<?=$color_page_lt_bg?>><B>
        <LI><A HREF="librarycount.php?SID=<?echo $SID;?>">Enter Hourly Count</A>
	<? if($userdata["IsAdmin"]=="Y"){ ?>
	<LI><A HREF="viewlibrarycount.php?SID=<?echo $SID;?>">View Count Report</A>
	<? } ?>
</B></TD></TR>
</TABLE>
<BR>
