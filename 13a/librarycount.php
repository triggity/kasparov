...
$title = "Enter Hourly Count";
MustLogIn();

//form for on time submission
echo "<h2>Form for Current Hour Submission</h2>";
echo "Please enter how many people are currently using the library computers.<br>";
...
echo "<form action=\"process_report.php?SID=$SID\" method=\"post\">";
